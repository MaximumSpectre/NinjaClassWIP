...
{
	public class PinkPhaseshiv : NinjaItem
	{
		public string Projectile = "PinkPhaseshivProjectile";           // the main projectile
		public string MegaProjectile = "PinkPhaseshivProjectileMega";   // the MEGA projectile
		...
		public override void AddRecipes()
		{
			if (NinjaClass.thoriumLoaded)
			{
				...
				recipe.AddIngredient(ModLoader.GetMod("ThoriumMod"), "Opal", 5);
