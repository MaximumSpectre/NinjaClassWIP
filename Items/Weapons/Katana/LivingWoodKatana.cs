...
namespace NinjaClass.Items.Weapons.Katana
{
	public class LivingWoodKatana : NinjaItem
	{
		public string Projectile = "LivingWoodKatanaProjectile";           // the main projectile
		public string MegaProjectile = "LivingWoodKatanaProjectileMega";   // the MEGA projectile
		public override void SetDefaults()
		{
			item.shootSpeed = 1f;// speed of the projectile
			item.damage = 12;// damage of the weapon
			item.knockBack = 3.8f;// knockback of the weapon
