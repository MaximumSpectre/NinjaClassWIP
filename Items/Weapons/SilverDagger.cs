...
{
    public class SilverDagger : NinjaItem
    {
        public string Projectile = "SilverDaggerProjectile";           // the main projectile
        public string MegaProjectile = "SilverDaggerProjectileMega";   // the MEGA projectile
