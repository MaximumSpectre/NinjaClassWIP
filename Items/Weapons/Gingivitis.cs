...
{
    public class Gingivitis : NinjaItem
    {
        public string Projectile = "GingivitisProjectile";           // the main projectile
        public string MegaProjectile = "GingivitisProjectileMega";   // the MEGA projectile
