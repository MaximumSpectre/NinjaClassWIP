...
namespace NinjaClass.Items.Weapons.Phaseshivs{
	public class CyanPhaseshiv : NinjaItem{
		public string Projectile = "CyanPhaseshivProjectile";			// the main projectile
		public string MegaProjectile = "CyanPhaseshivProjectileMega";   // the MEGA projectile
		...
		public override void AddRecipes()
		{
			if (NinjaClass.thoriumLoaded)
			{
				...
				recipe.AddIngredient(ModLoader.GetMod("ThoriumMod"), "Pearl", 5);
