...
{
	public class BlackPhaseshiv : NinjaItem
	{
		public string Projectile = "BlackPhaseshivProjectile";           // the main projectile
		public string MegaProjectile = "BlackPhaseshivProjectileMega";   // the MEGA projectile
		...
		{
			if (NinjaClass.thoriumLoaded)
			{
				ModRecipe recipe = new ModRecipe(mod);
				recipe.AddIngredient(ItemID.MeteoriteBar, 10);
				recipe.AddIngredient(ModLoader.GetMod("ThoriumMod"), "Onyx", 5);
