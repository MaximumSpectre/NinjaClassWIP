...
{
	public class WhitePhaseshiv : NinjaItem
	{
		public string Projectile = "WhitePhaseshivProjectile";           // the main projectile
		public string MegaProjectile = "WhitePhaseshivProjectileMega";   // the MEGA projectile
