...
{
	public class GreenPhaseshiv : NinjaItem
	{
		public string Projectile = "GreenPhaseshivProjectile";           // the main projectile
		public string MegaProjectile = "GreenPhaseshivProjectileMega";   // the MEGA projectile
