...
{
	public class GreenPhaseshivProjectile : ModProjectile
	{
		...
		public override void AI()
		{
			...
			NormalAI();
			Lighting.AddLight(projectile.Center, 0.19f, 0.80f, 0.19f); // R G B values from 0 to 1f. This is the red from the Crimson Heart pet
		...
		{
			Texture2D texture = mod.GetTexture("Projectiles/Phaseshivs/GreenPhaseshivProjectile_Glow");
			spriteBatch.Draw
			(
				texture,
				projectile.position,
