...
{
	public class BlackPhaseshivProjectileMega : ModProjectile
	{
		...
		public int killDust = 54;                   // which dust used when it dies
		...
		public override void AI()
		{
			...
			NormalAI();
			Lighting.AddLight(projectile.Center, 0.05f, 0.05f, 0.05f); // R G B values from 0 to 1f. This is the red from the Crimson Heart pet
		}
		...
		{
			Texture2D texture = mod.GetTexture("Projectiles/Phaseshivs/BlackPhaseshivProjectile_Glow");
			spriteBatch.Draw
			(
				texture,
				projectile.position,
