...
{
	public class CyanPhaseshivProjectileMega : ModProjectile
	{
		...
		public override void AI()
		{
			...
			NormalAI();
			Lighting.AddLight(projectile.Center, 0.25f, 0.41f, 0.96f); // R G B values from 0 to 1f. This is the red from the Crimson Heart pet
		}
		...
		{
			Texture2D texture = mod.GetTexture("Projectiles/Phaseshivs/CyanPhaseshivProjectile_Glow");
			spriteBatch.Draw
			(
				texture,
				projectile.position,
