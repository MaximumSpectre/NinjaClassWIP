...
{
	public class PinkPhaseshivProjectileMega : ModProjectile
	{
		...
		public int killDust = 86;                   // which dust used when it dies
		...
		public override void AI()
		{
			...
			NormalAI();
			Lighting.AddLight(projectile.Center, 1f, 0.41f, 0.7f); // R G B values from 0 to 1f. This is the red from the Crimson Heart pet
		}
		...
		{
			Texture2D texture = mod.GetTexture("Projectiles/Phaseshivs/PinkPhaseshivProjectile_Glow");
			spriteBatch.Draw
			(
				texture,
				projectile.position,
