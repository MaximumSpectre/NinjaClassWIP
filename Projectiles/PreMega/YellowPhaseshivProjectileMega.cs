...
{
	public class YellowPhaseshivProjectileMega : ModProjectile
	{
		...
		public override void AI()
		{
			...
			NormalAI();
			Lighting.AddLight(projectile.Center, 0.98f, 0.98f, 0.39f);
		}
		...
		{
			Texture2D texture = mod.GetTexture("Projectiles/Phaseshivs/YellowPhaseshivProjectile_Glow");
			spriteBatch.Draw
			(
				texture,
				projectile.position,
