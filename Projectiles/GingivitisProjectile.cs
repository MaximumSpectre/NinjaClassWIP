...
{
    public class GingivitisProjectile : ModProjectile
    {
        public int duration = 40;                // the time the projectile stays in the air
        public int penetration = 3;             // how many eneemies the projectile penetrate
        public const float drag = 0.99f;            // the drag of the projectile
        ...
        public override void ModifyHitNPC(NPC target, ref int damage, ref float knockback, ref bool crit, ref int hitDirection)
        {
            ...
            {
                target.AddBuff(BuffType<Buffs.Rot>(), (30 + Main.rand.Next(90)));
            }
        ...
        private void UpdateStickyJavelins(NPC target)
        {
            ...
            for (int i = 0; i < Main.maxProjectiles; i++) // Loop all projectiles
            {
                ...
                if (i != projectile.whoAmI // Make sure the looped projectile is not the current javelin
                    ...
                    && currentProjectile.modProjectile is GingivitisProjectile daggerProjectile // Use a pattern match cast so we can access the projectile like an ExampleJavelinProjectile
