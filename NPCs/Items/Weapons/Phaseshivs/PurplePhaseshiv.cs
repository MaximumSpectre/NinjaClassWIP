...
{
	public class PurplePhaseshiv : NinjaItem
	{
		public string Projectile = "PurplePhaseshivProjectile";           // the main projectile
		public string MegaProjectile = "PurplePhaseshivProjectileMega";   // the MEGA projectile
