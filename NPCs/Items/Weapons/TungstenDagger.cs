...
{
    public class TungstenDagger : NinjaItem
    {
        public string Projectile = "TungstenDaggerProjectile";           // the main projectile
        public string MegaProjectile = "TungstenDaggerProjectileMega";   // the MEGA projectile
        public override void SetDefaults()
        {
            item.shootSpeed = 10.9f;// speed of the projectile
            item.damage = 12;// damage of the weapon
            item.knockBack = 2.5f;// knockback of the weapon
            ...
            item.value = Item.sellPrice(silver: 4);    // the price of the item
